...
struct _usb_class_phdc_qos_bin
{
   ...
   uint8_t  num_tfr;    /* num of transfers that follow the meta data packet.  used only when meta_data is TRUE */
...
(
   ...
   uint8_t     num_tfr,       /* no. of transfers to follow with given channel--only valid if meta data is true */
   uint8_t     current_qos,   /* qos of the transfers to follow--only valid if meta data is true */
