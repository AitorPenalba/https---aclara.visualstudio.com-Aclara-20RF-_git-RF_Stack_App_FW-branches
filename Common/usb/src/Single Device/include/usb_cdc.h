 ...
 *****************************************************************************/
extern uint32_t USB_Class_CDC_Init ( CDC_CONFIG_STRUCT_PTR cdc_config_ptr );
/**************************************************************************//*!
 ...
 *****************************************************************************/
extern uint32_t USB_Class_CDC_Deinit ( CDC_HANDLE cdc_handle );
/**************************************************************************//*!
 ...
 *****************************************************************************/
uint8_t USB_Pstn_Init ( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, USB_CLASS_CALLBACK_STRUCT_PTR pstn_cb );
/**************************************************************************//*!
 ...
 *****************************************************************************/
uint8_t USB_Pstn_Deinit ( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr );
/**************************************************************************//*!
 ...
 *****************************************************************************/
extern uint8_t PSTN_Get_Line_Coding( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, USB_SETUP_STRUCT * setup_packet, uint8_t **data, uint32_t *size );
 ...
 *****************************************************************************/
extern uint8_t PSTN_Set_Line_Coding( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, USB_SETUP_STRUCT * setup_packet, uint8_t **data, uint32_t *size );
 ...
 *****************************************************************************/
extern uint8_t PSTN_Set_Ctrl_Line_State( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, USB_SETUP_STRUCT * setup_packet, uint8_t **data, uint32_t *size );
 ...
 *****************************************************************************/
extern uint8_t PSTN_Send_Break( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, USB_SETUP_STRUCT * setup_packet, uint8_t **data, uint32_t *size );
 ...
 *****************************************************************************/
extern uint8_t PSTN_Get_Comm_Feature( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, USB_SETUP_STRUCT * setup_packet, uint8_t **data, uint32_t *size );
 ...
 *****************************************************************************/
extern uint8_t PSTN_Set_Comm_Feature( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, USB_SETUP_STRUCT * setup_packet, uint8_t **data, uint32_t *size );
 ...
 *****************************************************************************/
extern uint8_t PSTN_Rndis_Message_Set( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, USB_SETUP_STRUCT * setup_packet, uint8_t **data, uint32_t *size );
/**************************************************************************//*!
 ...
 *****************************************************************************/
extern uint8_t PSTN_Rndis_Message_Get( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, USB_SETUP_STRUCT * setup_packet, uint8_t **data, uint32_t *size );


extern void RNDIS_Initialize_Command ( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, uint8_t **data, uint32_t *size );
extern void RNDIS_Query_Command ( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, uint8_t **data, uint32_t *size );
extern void RNDIS_Set_Command ( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, uint8_t **data, uint32_t *size );
extern void RNDIS_Reset_Command ( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, uint8_t **data, uint32_t *size );
extern void RNDIS_Indicate_Status_Command ( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, uint8_t **data, uint32_t *size );
extern void RNDIS_Keepalive_Command ( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr, uint8_t **data, uint32_t *size );
extern void RNDIS_Halt_Command ( CDC_DEVICE_STRUCT_PTR cdc_obj_ptr );
