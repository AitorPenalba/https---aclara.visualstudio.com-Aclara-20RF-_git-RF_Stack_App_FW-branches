...
/**************************************************************************//*!
   ...
   @return status
           ...
           Others           : Errors
 *****************************************************************************/
extern uint8_t USB_MSC_LBA_Transfer ( MSC_DEVICE_STRUCT_PTR   msc_obj_ptr, bool                    direction, PTR_LBA_INFO_STRUCT     lba_info_ptr );
...
*****************************************************************************/
extern uint8_t USB_MSC_SCSI_Init(MSC_DEVICE_STRUCT_PTR msc_obj_ptr, USB_CLASS_CALLBACK_STRUCT_PTR cb, PTR_DEVICE_LBA_INFO_STRUCT device_info_ptr, uint32_t implementing_disk_drive);
