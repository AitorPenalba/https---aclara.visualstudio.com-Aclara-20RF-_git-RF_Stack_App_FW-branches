...
// MOD_type: 3    Rsymb(sps): 2400    Fdev(Hz): 2000    RXBW(Hz): 5700    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2
...
// # WB filter 3 (BW =   5.79 kHz);  NB-filter 3 (BW = 5.79 kHz)
//
...
*/
#define RF_SYNC_CONFIG_6 0x11, 0x11, 0x06, 0x00, 0x03, 0x33, 0x33, 0x33, 0x33, 0x00
...
//   MODEM_FREQ_DEV_1 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_MOD_TYPE_12_1 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x01, 0x77, 0x00, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x00
...
//   MODEM_BCR_NCO_OFFSET_0 - RX BCR NCO offset value (an unsigned 22-bit number).
*/
#define RF_MODEM_IF_FREQ_2_12 0x11, 0x20, 0x0C, 0x1B, 0x03, 0x80, 0x00, 0xF0, 0x20, 0x0C, 0xE8, 0x00, 0x62, 0x05, 0x3E, 0x2D
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_BCR_GAIN_1_12 0x11, 0x20, 0x0C, 0x27, 0x03, 0x22, 0x02, 0x00, 0x00, 0x00, 0x12, 0xC0, 0x15, 0x02, 0x1E, 0xE0
...
//   MODEM_RSSI_COMP - RSSI compensation value.
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x03, 0x01, 0x62, 0x02, 0x00, 0xFF, 0x06, 0x02, 0x18, 0x40
