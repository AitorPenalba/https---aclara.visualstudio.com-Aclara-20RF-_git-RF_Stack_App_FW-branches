...
// INPUT DATA
/*
// Crys_freq(Hz): 29491200    Crys_tol(ppm): 20    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 1    ANT_DIV: 0    PM_pattern: 0
// MOD_type: 3    Rsymb(sps): 2400    Fdev(Hz): 2000    RXBW(Hz): 5600    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2
...
// # WB filter 3 (BW =   5.69 kHz);  NB-filter 3 (BW = 5.69 kHz)
//
// Modulation index: 1.667
*/
...
*/
#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x07, 0x14, 0x00, 0x0F, 0x12, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_SYNC_CONFIG_10 0x11, 0x11, 0x0A, 0x00, 0x03, 0x33, 0x33, 0x33, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_PKT_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x00, 0x04, 0x00, 0x30, 0xFF, 0xFF, 0x20, 0x03, 0x00, 0x00, 0x00, 0x00, 0x30
...
//   MODEM_FREQ_DEV_1 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_MOD_TYPE_12_1 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x01, 0x77, 0x00, 0x05, 0xC2, 0x00, 0x00, 0x00, 0x00
...
//   MODEM_FREQ_DEV_0 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_FREQ_DEV_0_1_1 0x11, 0x20, 0x01, 0x0C, 0x8E
...
//   MODEM_BCR_NCO_OFFSET_0 - RX BCR NCO offset value (an unsigned 22-bit number).
*/
#define RF_MODEM_IF_FREQ_2_12 0x11, 0x20, 0x0C, 0x1B, 0x03, 0x80, 0x00, 0xF0, 0x20, 0x0C, 0xE8, 0x00, 0x60, 0x05, 0x55, 0x55
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_BCR_GAIN_1_12 0x11, 0x20, 0x0C, 0x27, 0x03, 0x33, 0x02, 0x00, 0x00, 0x00, 0x12, 0xC0, 0x15, 0x02, 0x1E, 0xE0
...
//   MODEM_OOK_MISC - Selects the detector(s) used for demodulation of an OOK signal, or for demodulation of a (G)FSK signal when using the asynchronous demodulator.
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12_1 0x11, 0x20, 0x0C, 0x38, 0x11, 0x15, 0x15, 0x80, 0x1A, 0x6A, 0xAB, 0x00, 0x28, 0x0C, 0xA4, 0x23
...
//   MODEM_RSSI_COMP - RSSI compensation value.
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x03, 0x01, 0x69, 0x02, 0x00, 0xFF, 0x06, 0x02, 0x18, 0x40
...
//   MODEM_DSA_MISC - Miscellaneous detection of signal arrival bits.
*/
#define RF_MODEM_DSA_CTRL1_5_1 0x11, 0x20, 0x05, 0x5B, 0x40, 0x04, 0x0B, 0x78, 0x20
