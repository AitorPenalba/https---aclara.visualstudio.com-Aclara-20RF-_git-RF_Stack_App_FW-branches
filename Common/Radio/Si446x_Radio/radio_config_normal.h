...
// INPUT DATA
/*
// Crys_freq(Hz): 30000000    Crys_tol(ppm): 20    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 1    Ch_Fil_Bw_AFC: 1    ANT_DIV: 0    PM_pattern: 0
...
// # WB filter 6 (BW =   8.37 kHz);  NB-filter 6 (BW = 8.37 kHz)
//
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x3B, 0x09, 0x00, 0x00, 0x03, 0x6A, 0x20, 0xFE
...
*/
#define RF_SYNC_CONFIG_6 0x11, 0x11, 0x06, 0x00, 0x03, 0x91, 0x22, 0xDA, 0x83, 0x00
...
//   MODEM_FREQ_DEV_1 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_MOD_TYPE_12_1 0x11, 0x20, 0x0C, 0x00, 0x05, 0x00, 0x07, 0x02, 0xEE, 0x00, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x00
...
//   MODEM_FREQ_DEV_0 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_FREQ_DEV_0_1_1 0x11, 0x20, 0x01, 0x0C, 0xD2
...
//   MODEM_BCR_NCO_OFFSET_0 - RX BCR NCO offset value (an unsigned 22-bit number).
*/
#define RF_MODEM_IF_FREQ_2_12 0x11, 0x20, 0x0C, 0x1B, 0x03, 0x80, 0x00, 0xB0, 0x20, 0x0C, 0xE8, 0x00, 0x62, 0x05, 0x3E, 0x2D
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_BCR_GAIN_1_12 0x11, 0x20, 0x0C, 0x27, 0x04, 0x2E, 0x02, 0x02, 0x00, 0x00, 0x12, 0xC0, 0x2A, 0x01, 0x88, 0xE0
...
//   MODEM_RSSI_COMP - RSSI compensation value.
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x03, 0x01, 0x0A, 0x02, 0x00, 0xFF, 0x06, 0x02, 0x18, 0x40
...
//   PA_TC - Configuration of PA ramping parameters.
*/
#define RF_PA_MODE_4 0x11, 0x22, 0x04, 0x00, 0x18, 0x05, 0xC0, 0x1D
...
//   FREQ_CONTROL_VCOCNT_RX_ADJ - Adjust target count for VCO calibration in RX mode.
*/
#define RF_FREQ_CONTROL_INTE_8_1 0x11, 0x40, 0x08, 0x00, 0x3C, 0x09, 0xDA, 0x74, 0x03, 0x6A, 0x20, 0xFE
