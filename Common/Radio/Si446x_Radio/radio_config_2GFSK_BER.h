...
// INPUT DATA
/*
// Crys_freq(Hz): 30000000    Crys_tol(ppm): 1    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 0    ANT_DIV: 0    PM_pattern: 0
// MOD_type: 3    Rsymb(sps): 4800    Fdev(Hz): 1800    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2
// RF Freq.(MHz): 459.2375    API_TC: 29    fhst: 12500    inputBW: 0    BERT: 1    RAW_dout: 0    D_source: 1    Hi_pfm_div: 1
...
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x06, 0x8D, 0xB9, 0x00, 0x00, 0x02, 0xC0, 0x08, 0x00, 0x12, 0x80, 0x23
...
//   MODEM_FREQ_DEV_1 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_MOD_TYPE_12_1 0x11, 0x20, 0x0C, 0x00, 0x0B, 0x00, 0x07, 0x02, 0xEE, 0x00, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x00
...
//   MODEM_IF_CONTROL - Selects Fixed-IF, Scaled-IF, or Zero-IF mode of RX Modem operation.
*/
#define RF_MODEM_TX_FILTER_COEFF_8_12 0x11, 0x20, 0x0C, 0x0F, 0x5D, 0x57, 0x49, 0x37, 0x25, 0x16, 0x0C, 0x05, 0x02, 0x01, 0x00, 0x08
...
//   MODEM_BCR_NCO_OFFSET_0 - RX BCR NCO offset value (an unsigned 22-bit number).
*/
#define RF_MODEM_IF_FREQ_2_12 0x11, 0x20, 0x0C, 0x1B, 0x03, 0x80, 0x00, 0xB0, 0x10, 0x0C, 0xE8, 0x00, 0x41, 0x07, 0xDD, 0x44
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_BCR_GAIN_1_12 0x11, 0x20, 0x0C, 0x27, 0x07, 0xFF, 0x02, 0xC0, 0x08, 0x00, 0x12, 0x80, 0x2A, 0x01, 0x92, 0xA0
...
//   MODEM_OOK_MISC - Selects the detector(s) used for demodulation of an OOK signal, or for demodulation of a (G)FSK signal when using the asynchronous demodulator.
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12_1 0x11, 0x20, 0x0C, 0x38, 0x11, 0x0E, 0x0E, 0x80, 0x1A, 0x30, 0x00, 0x00, 0x28, 0x0C, 0xA4, 0x23
...
//   MODEM_RSSI_CONTROL - Control of the averaging modes and latching time for reporting RSSI value(s).
*/
#define RF_MODEM_RAW_CONTROL_8 0x11, 0x20, 0x08, 0x45, 0x03, 0x00, 0xEF, 0x02, 0x00, 0xFF, 0x06, 0x02
...
//   MODEM_RSSI_COMP - RSSI compensation value.
*/
#define RF_MODEM_RSSI_CONTROL_3 0x11, 0x20, 0x03, 0x4C, 0x09, 0x14, 0x40
