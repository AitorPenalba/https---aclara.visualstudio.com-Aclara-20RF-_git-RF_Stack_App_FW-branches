...
// INPUT DATA
/*
// Crys_freq(Hz): 29491200    Crys_tol(ppm): 1    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 1    ANT_DIV: 0    PM_pattern: 0
// MOD_type: 5    Rsymb(sps): 4800    Fdev(Hz): 1000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2
// RF Freq.(MHz): 900    API_TC: 29    fhst: 12500    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1
// API_ARR_Det_en: 0    Fdev_error: 0    API_ETSI: 0
//
// # RX IF frequency is  -460800 Hz
// # WB filter 3 (BW =  11.38 kHz);  NB-filter 3 (BW = 11.38 kHz)
//
...
*/
#define RF_MODEM_TX_RAMP_DELAY_12 0x11, 0x20, 0x0C, 0x18, 0x01, 0x00, 0x08, 0x03, 0xC0, 0x00, 0xB0, 0x10, 0x0C, 0xE8, 0x00, 0x4D
...
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x06, 0xAA, 0xAB, 0x00, 0x00, 0x02, 0xC0, 0x08, 0x00, 0x12, 0x00, 0x12
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x3D, 0x08, 0x80, 0x00, 0x01, 0xBC, 0x20, 0xFF
...
//   MODEM_FREQ_DEV_0 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_FREQ_DEV_0_1_1 0x11, 0x20, 0x01, 0x0C, 0x6B
...
//   MODEM_BCR_NCO_OFFSET_0 - RX BCR NCO offset value (an unsigned 22-bit number).
*/
#define RF_MODEM_IF_FREQ_2_12 0x11, 0x20, 0x0C, 0x1B, 0x03, 0xC0, 0x00, 0xB0, 0x20, 0x0C, 0xE8, 0x00, 0x60, 0x05, 0x55, 0x55
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_BCR_GAIN_1_12 0x11, 0x20, 0x0C, 0x27, 0x04, 0x44, 0x02, 0x02, 0x00, 0x00, 0x12, 0xC0, 0x15, 0x02, 0x1E, 0xE0
...
//   FREQ_CONTROL_VCOCNT_RX_ADJ - Adjust target count for VCO calibration in RX mode.
*/
#define RF_FREQ_CONTROL_INTE_8_1 0x11, 0x40, 0x08, 0x00, 0x3C, 0x08, 0x48, 0x00, 0x01, 0xBC, 0x20, 0xFF
