...
#include "radio_config_STAR_2400_TCXO_29_491.h"
#else
#include "radio_config_STAR_2400.h"
#endif
...
const tRadioConfiguration RadioConfiguration_STAR_2400 = RADIO_CONFIGURATION_DATA;
