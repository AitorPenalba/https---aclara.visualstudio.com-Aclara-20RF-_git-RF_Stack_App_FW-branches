...
// MOD_type: 3    Rsymb(sps): 7232    Fdev(Hz): 2000    RXBW(Hz): 8000    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2
...
// # WB filter 9 (BW =   8.05 kHz);  NB-filter 9 (BW = 8.05 kHz)
//
// Modulation index: 0.553
*/
...
*/
#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x0C, 0x14, 0x00, 0x0F, 0x12, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_SYNC_CONFIG_10 0x11, 0x11, 0x0A, 0x00, 0x01, 0x4B, 0x2D, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
//   MODEM_FREQ_DEV_1 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_MOD_TYPE_12_1 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x04, 0x6A, 0x00, 0x05, 0xC2, 0x00, 0x00, 0x00, 0x00
...
//   MODEM_BCR_NCO_OFFSET_0 - RX BCR NCO offset value (an unsigned 22-bit number).
*/
#define RF_MODEM_IF_FREQ_2_12 0x11, 0x20, 0x0C, 0x1B, 0x03, 0x80, 0x00, 0x70, 0x10, 0x0C, 0xE8, 0x00, 0x55, 0x06, 0x06, 0xD4
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_BCR_GAIN_1_12 0x11, 0x20, 0x0C, 0x27, 0x07, 0xFF, 0x02, 0x00, 0x00, 0x00, 0x12, 0xC0, 0x40, 0x00, 0xFC, 0xE0
...
//   MODEM_OOK_MISC - Selects the detector(s) used for demodulation of an OOK signal, or for demodulation of a (G)FSK signal when using the asynchronous demodulator.
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12_1 0x11, 0x20, 0x0C, 0x38, 0x11, 0x13, 0x13, 0x80, 0x1A, 0x23, 0x66, 0x00, 0x28, 0x0C, 0xA4, 0x23
...
//   MODEM_RSSI_COMP - RSSI compensation value.
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x03, 0x00, 0x87, 0x02, 0x00, 0xFF, 0x06, 0x02, 0x18, 0x40
...
//   MODEM_DSA_MISC - Miscellaneous detection of signal arrival bits.
*/
#define RF_MODEM_DSA_CTRL1_5_1 0x11, 0x20, 0x05, 0x5B, 0x40, 0x04, 0x04, 0x78, 0x20
