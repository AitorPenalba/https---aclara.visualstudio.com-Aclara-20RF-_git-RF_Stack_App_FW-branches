...
/* AES-DIRECT */
 ...
 WOLFSSL_API int  wc_AesCcmEncrypt_ex(Aes* aes, byte* out,
                                   ...
                                   byte* authTag, word32 authTagSz,
                                   const byte* authIn, word32 authInSz);
 WOLFSSL_API int  wc_AesCcmVerifyDecrypt(Aes* aes, const byte* in, word32 inSz, 
                              const byte* authTag, word32 authTagSz, word32 nonceSz,
                              byte lastCall);
 WOLFSSL_API void wc_AesCcmDecryptNoValidate(Aes* aes, byte* out, const byte* in, word32 inSz,
                              const byte* nonce, word32 nonceSz,
                              const byte* authTag, word32 authTagSz,
                              const byte* authIn, word32 authInSz,
