...
#define BSP_FEATURE_ELC_PERIPHERAL_MASK                   (0x0003D3FFU) // Positions of event link set registers (ELSRs) available on this MCU
...
#define BSP_FEATURE_FLASH_HP_SUPPORTS_DUAL_BANK           (0)  /* Aclara Modified to reduce the BL code size */
...
#define BSP_FEATURE_GPT_VALID_CHANNEL_MASK                (0x0F6U)
