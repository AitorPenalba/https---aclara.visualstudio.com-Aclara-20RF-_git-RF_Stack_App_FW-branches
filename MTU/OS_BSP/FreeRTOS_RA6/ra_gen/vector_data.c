/* generated vector source file - do not edit */
        ...
        BSP_DONT_REMOVE const fsp_vector_t g_vector_table[BSP_ICU_VECTOR_MAX_ENTRIES] BSP_PLACE_IN_SECTION(BSP_SECTION_APPLICATION_VECTORS) =
        {
            ...
            [24] = gpt_counter_overflow_isr, /* GPT1 COUNTER OVERFLOW (Overflow) */
            [25] = gpt_capture_a_isr, /* GPT1 CAPTURE COMPARE A (Compare match A) */
            [26] = spi_rxi_isr, /* SPI1 RXI (Receive buffer full) */
            [27] = spi_txi_isr, /* SPI1 TXI (Transmit buffer empty) */
            [28] = spi_tei_isr, /* SPI1 TEI (Transmission complete event) */
            [29] = spi_eri_isr, /* SPI1 ERI (Error) */
            [30] = fcu_frdyi_isr, /* FCU FRDYI (Flash ready interrupt) */
            [31] = fcu_fiferr_isr, /* FCU FIFERR (Flash access error interrupt) */
            [32] = agt_int_isr, /* AGT0 INT (AGT interrupt) */
            [33] = r_icu_isr, /* ICU IRQ13 (External pin interrupt 13) */
            [34] = agt_int_isr, /* AGT1 INT (AGT interrupt) */
            [35] = r_icu_isr, /* ICU IRQ14 (External pin interrupt 14) */
            [36] = r_icu_isr, /* ICU IRQ4 (External pin interrupt 4) */
            [37] = gpt_counter_overflow_isr, /* GPT2 COUNTER OVERFLOW (Overflow) */
            [38] = gpt_capture_b_isr, /* GPT2 CAPTURE COMPARE B (Compare match B) */
        };
        const bsp_interrupt_event_t g_interrupt_event_link_select[BSP_ICU_VECTOR_MAX_ENTRIES] =
        {
            ...
            [24] = BSP_PRV_IELS_ENUM(EVENT_GPT1_COUNTER_OVERFLOW), /* GPT1 COUNTER OVERFLOW (Overflow) */
            [25] = BSP_PRV_IELS_ENUM(EVENT_GPT1_CAPTURE_COMPARE_A), /* GPT1 CAPTURE COMPARE A (Compare match A) */
            [26] = BSP_PRV_IELS_ENUM(EVENT_SPI1_RXI), /* SPI1 RXI (Receive buffer full) */
            [27] = BSP_PRV_IELS_ENUM(EVENT_SPI1_TXI), /* SPI1 TXI (Transmit buffer empty) */
            [28] = BSP_PRV_IELS_ENUM(EVENT_SPI1_TEI), /* SPI1 TEI (Transmission complete event) */
            [29] = BSP_PRV_IELS_ENUM(EVENT_SPI1_ERI), /* SPI1 ERI (Error) */
            [30] = BSP_PRV_IELS_ENUM(EVENT_FCU_FRDYI), /* FCU FRDYI (Flash ready interrupt) */
            [31] = BSP_PRV_IELS_ENUM(EVENT_FCU_FIFERR), /* FCU FIFERR (Flash access error interrupt) */
            [32] = BSP_PRV_IELS_ENUM(EVENT_AGT0_INT), /* AGT0 INT (AGT interrupt) */
            [33] = BSP_PRV_IELS_ENUM(EVENT_ICU_IRQ13), /* ICU IRQ13 (External pin interrupt 13) */
            [34] = BSP_PRV_IELS_ENUM(EVENT_AGT1_INT), /* AGT1 INT (AGT interrupt) */
            [35] = BSP_PRV_IELS_ENUM(EVENT_ICU_IRQ14), /* ICU IRQ14 (External pin interrupt 14) */
            [36] = BSP_PRV_IELS_ENUM(EVENT_ICU_IRQ4), /* ICU IRQ4 (External pin interrupt 4) */
            [37] = BSP_PRV_IELS_ENUM(EVENT_GPT2_COUNTER_OVERFLOW), /* GPT2 COUNTER OVERFLOW (Overflow) */
            [38] = BSP_PRV_IELS_ENUM(EVENT_GPT2_CAPTURE_COMPARE_B), /* GPT2 CAPTURE COMPARE B (Compare match B) */
        };
        #endif