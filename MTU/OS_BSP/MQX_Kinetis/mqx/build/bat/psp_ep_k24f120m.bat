...
rem delete everything except the library (psp.a) just created
del "%OUTPUTDIR%\*.h"      /Q
...
rem copy "%ROOTDIR%\mqx\source\include\ipc.h"                         "%OUTPUTDIR%\ipc.h" /Y
rem copy "%ROOTDIR%\mqx\source\include\ipc_pcb.h"                     "%OUTPUTDIR%\ipc_pcb.h" /Y
rem copy "%ROOTDIR%\mqx\source\include\ipc_pcbv.h"                    "%OUTPUTDIR%\ipc_pcbv.h" /Y
...
rem copy "%ROOTDIR%\mqx\source\include\pcb.h"                         "%OUTPUTDIR%\pcb.h" /Y
...
copy "%ROOTDIR%\mqx\source\psp\cortex_m\cpu\MK24F25612.h"         "%OUTPUTDIR%\MK24F25612.h" /Y
