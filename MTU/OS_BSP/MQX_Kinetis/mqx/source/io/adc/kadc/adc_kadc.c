...
_mqx_int _adc_hw_ioctl(MQX_FILE_PTR f, _mqx_uint cmd, void *param_ptr)
{
    ...
    switch (cmd)
    {
        ...
        case ADC_IOCTL_SET_LONG_SAMPLE:
            ...
            //Aclara Apr-06-2015 Fixed usage of param_ptr to be dereferenced next four places
        ...
        case ADC_IOCTL_SET_HW_AVERAGING:
            ...
            //Aclara Apr-06-2015 Fixed usage of param_ptr to be dereferenced next five places
        ...
        case ADC_IOCTL_SET_OFFSET: {
            //Aclara Apr-06-2015 Fixed usage of param_ptr to be dereferenced
        ...
        case ADC_IOCTL_SET_REFERENCE: {
            ...
            //Aclara Apr-06-2015 Fixed usage of param_ptr to be dereferenced next three places
