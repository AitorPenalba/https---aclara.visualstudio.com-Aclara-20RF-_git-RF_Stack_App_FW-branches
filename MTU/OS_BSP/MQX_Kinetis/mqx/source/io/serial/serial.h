...
#define IO_IOCTL_SERIAL_SET_MA_ENABLE    _IO(IO_TYPE_SERIAL, 0x1F)   /* Aclara Added 2015-Mar-19 to Support 9-bit mode */
#define IO_IOCTL_SERIAL_GET_MA_ENABLE    _IO(IO_TYPE_SERIAL, 0x20)   /* Aclara Added 2015-Mar-19 to Support 9-bit mode */
#define IO_IOCTL_SERIAL_DISABLE_TX       _IO(IO_TYPE_SERIAL,0x21)    /* Aclara Added 2017-Jan-10 for Optical port */
#define IO_IOCTL_SERIAL_ENABLE_TX        _IO(IO_TYPE_SERIAL,0x22)    /* Aclara Added 2017-Jan-10 for Optical port */
#define IO_IOCTL_SERIAL_FORCE_RECEIVE    _IO(IO_TYPE_SERIAL,0x23)    /* Aclara Added 2017-Jan-10 for Optical port */
