...
{ /* Body */
   ...
   switch (cmd) {
      ...
      /* This command added 1/10/17 by Aclara to force a control-c into a receive queue.  */
      case IO_IOCTL_SERIAL_FORCE_RECEIVE:
         (void)_io_serial_int_addc(int_io_dev_ptr, *(uint32_t *)param_ptr);
         break;
