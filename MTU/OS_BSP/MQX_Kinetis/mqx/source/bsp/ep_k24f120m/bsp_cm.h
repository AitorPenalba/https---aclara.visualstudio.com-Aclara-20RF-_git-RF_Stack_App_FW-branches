...
// Aclara Added
#define SWITCH_FROM_48MHZ               1       /* Regardless of BL clock config, App switches to 8MHz external */
...
#define CPU_CORE_CLK_HZ_CONFIG_3          8000000UL /* Core clock frequency in clock configuration 3 */
#define CPU_BUS_CLK_HZ_CONFIG_3           8000000UL /* Bus clock frequency in clock configuration 3 */
#define CPU_FLASH_CLK_HZ_CONFIG_3         2666666UL /* FLASH clock frequency in clock configuration 3 */
...
#if ( SWITCH_FROM_48MHZ == 1 )
    BSP_CLOCK_CONFIGURATION_3,          /* 21 MHz PBE  PLL Bypassed with 8MHz External clock  */
#endif
