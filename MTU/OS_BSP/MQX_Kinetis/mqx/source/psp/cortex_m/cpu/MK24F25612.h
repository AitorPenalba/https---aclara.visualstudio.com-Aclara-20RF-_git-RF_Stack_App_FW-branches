...
**     Version:             rev. 1.0, 2014-05-13
**     Build:               b140522
**
**     Abstract:
**         This header file implements peripheral memory map for MK24F25612
**         processor.
**
 ...
 * @version 1.0
 * @date 2014-05-13
 * @brief Peripheral memory map for MK24F25612
 *
 * This header file implements peripheral memory map for MK24F25612 processor.
 */
...
#if !defined(MCU_MK24F25612)  /* Check if memory map has not been already included */
...
typedef enum {
  ...
  INT_FTFE                     = 34,               /**< FTFA Command complete interrupt */   /* Aclara Changed to correct FTF type */
  ...
  INT_Reserved88               = 88,               /**< Reserved interrupt 88 */
...
/* Aclara 2016-Feb-17 Added to allow compile - THE K24 DOES HAVE THESE REGISTERS */
/* ----------------------------------------------------------------------------
   -- CoreDebug
   ---------------------------------------------------------------------------- */
...
/* Aclara 2016-Feb-17 End Added to allow compile - THE K24 DOES HAVE THESE REGISTERS */
/* ----------------------------------------------------------------------------
   -- DAC
   ---------------------------------------------------------------------------- */
...
/* Aclara 16-Jun-2016 SMG Replaced FTFA with correct Flash Memory (FTF) type */
/* ----------------------------------------------------------------------------
   -- FTFE
   ---------------------------------------------------------------------------- */
...
typedef struct USB_MemMap {
  ...
  uint8_t CLK_RECOVER_INT_EN;                      /**< Clock recovery combined interrupt enable, offset: 0x154 */
...
#define USB0_CLK_RECOVER_INT_EN                  USB_CLK_RECOVER_INT_EN_REG(USB0_BASE_PTR)
...
#else /* #if !defined(MCU_MK24F25612) */
...
#endif  /* #if !defined(MCU_MK24F25612) */
