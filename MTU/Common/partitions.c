 ...
 *
 * Contents: Contains partition information for performing memory I/O.  Provides an access table to all of the
 *   memory commands.
 *
 ***********************************************************************************************************************
...
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="File Variable Definitions (Static)">
/* ****************************************************************************************************************** */
/* FILE VARIABLE DEFINITIONS */

static bool flushPartitions_ = false;
...
// <editor-fold defaultstate="collapsed" desc="void PAR_appTask( uint32_t Arg0 )">
#if RTOS
/***********************************************************************************************************************
 *
...
#endif
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t PAR_init( void ) - Common API">
#if RTOS
/***********************************************************************************************************************
 *
...
#endif
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t PAR_initRtos(void)">
/***********************************************************************************************************************
 *
...
returnStatus_t PAR_initRtos( void )
{
   ...
   (void)PAR_partitionFptr.parOpen(&pPTbl, ePART_NV_APP_RAW, 0);  /* Gets partition information for IOCTL cmd below. */
   (void)PAR_partitionFptr.parIoctl((void *)&dvrCmd, (void *)&dvrData, pPTbl);
   return (eSUCCESS);
}
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t init(void)">
/***********************************************************************************************************************
 *
 * Function Name: init
 *
...
static returnStatus_t init( void )
{
   ...
   for ( i = 0, pPartitionData = &sPartitionData[0];
         ...
         i++, pPartitionData++ )
   {
      DeviceDriverMem_t const **pNextDvr = sPartitionData[i].pDriverTbl + 1; /* Next Driver for the lower layers */
...
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t open(PartitionData_t **pPartitionTbl, ePartitionName ePartitionId, uint32_t u32UpdateRate)">
/***********************************************************************************************************************
 *
 * Function Name: open
 *
...
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t close(PartitionData_t *pPartitionTbl)">
/***********************************************************************************************************************
 *
 * Function Name: close
 *
...
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t pwrMode(ePowerMode powerMode)">
/***********************************************************************************************************************
 *
...
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t read(uint8_t *pDest, dSize dSrc, lCnt Cnt, PartitionData_t *pPartitionTbl)">
/***********************************************************************************************************************
 *
 * Function Name: read
 *
...
static returnStatus_t read( uint8_t *pDest, dSize dSrc, lCnt cnt, PartitionData_t const *pPTbl )
{
   ...
   if ((PartitionData_t const *)NULL == pPTbl)
   {
      ...
      /* If the there are bytes left & no access error(s), then more bytes were requested than exist in the partition
       * table. */
...
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t write(dSize lDest, uint8_t *pSrc, lCnt Cnt, PartitionData_t *pPartitionTbl)">
/***********************************************************************************************************************
 *
 * Function Name: write
 *
...
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t erase(lAddr lDest, lCnt Cnt, PartitionData_t *pPartitionTbl)">
/***********************************************************************************************************************
 *
 * Function Name: erase
 *
...
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t flush(PartitionData_t *pPartitionTbl)">
/***********************************************************************************************************************
 *
 * Function Name: flush
 *
...
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t restore(lAddr lDest, lCnt Cnt, PartitionData_t *pPartitionTbl)">
/***********************************************************************************************************************
 *
...
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t ioctl(void *pCmd, void *pData, PartitionData_t *pPartitionTbl)">
/***********************************************************************************************************************
 *
 * Function Name: ioctl
 *
...
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="bool PAR_timeSlice(void)">
/***********************************************************************************************************************
 *
...
bool PAR_timeSlice(void)
{
   ...
   for (i = 0, pPartitionData = &sPartitionData[0];
        !retVal && (i < ARRAY_IDX_CNT(sPartitionData));
        i++, pPartitionData++)
   {
      /* Initialize the memory driver (create the mutexes and semaphores) */
...
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t size(ePartitionName ePName, lCnt *pPartitionSize)">
/***********************************************************************************************************************
 *
 * Function Name: size
 *
...
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="void PAR_flushPartitions(void)">
/***********************************************************************************************************************
 *
...
{
   flushPartitions_ = true;
}
/* ****************************************************************************************************************** */
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="PartitionData_t *PAR_GetFirstPartition(PAR_getNextMember_t *pMember)">
/***********************************************************************************************************************
 *
...
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="PartitionData_t *PAR_GetNextPartition(PAR_getNextMember_t *pMember)">
/***********************************************************************************************************************
 *
...
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="returnStatus_t PAR_ValidatePartitionTable(void)">
/***********************************************************************************************************************
 *
...
returnStatus_t PAR_ValidatePartitionTable( void )
{
   ...
   DBG_printf( "PId,   Partition Desc, Cached, Banked,    Ext Bus,   NV Type, Phy,, Adr St, Adr En,   Size, Erase Size, Error, Warn");

   /* Check for memory overlaps... */
   for ( parCnt = 0, pEntryUnderTest = sPartitionData;
        parCnt < ARRAY_IDX_CNT(sPartitionData);
        parCnt++, pEntryUnderTest++ )
   {
      pCached = _no;
      pBanked = _no;
      pError = _ok;
      ...
      CLRWDT();
      DBG_printf( "%3u,%17s,%7s,%7s,%11s, %14s,%7lu,%7lu,%7lu,%11lu,%6s, %-15s",
                 pEntryUnderTest->ePartition,
