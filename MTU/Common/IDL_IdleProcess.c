 ...
 *
 ******************************************************************************
 * Copyright (c) 2020 - 2022 ACLARA.  All rights reserved.
...
/* These values are exact copies from freeRTOS and were copied here to avoid modifying the actual freeRTOS code.
   ...
   the within port.c module.  They are used to unlock/lock LPM peripheral register. */
...
/*******************************************************************************
  ...
  Notes: This function was copied and utilized here to avoid possible tweaks which would
...
/*******************************************************************************
  ...
  Notes: This function supersedes the weak definition made by default freeRTOS.
         ...
         contained within the port.c module. It is utilized here to avoid possible tweaks
