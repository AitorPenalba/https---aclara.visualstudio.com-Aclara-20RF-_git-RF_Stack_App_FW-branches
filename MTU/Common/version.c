...
/* MACRO DEFINITIONS */
   ...
   #define BOOTLOADER_BUILD  ((uint16_t)1)   /* current bootloader build */
   ...
   #define FIRMWARE_BUILD  ((uint16_t)121)   /* current firmware build */ // Don't put a '0' in front of the rev number. It's going to be interpreted as an octal number and might not build.
#endif
