...
/* MACRO DEFINITIONS */
   ...
   #define FIRMWARE_BUILD  ((uint16_t)27)    /* current firmware build */ // Don't put a '0' in front of the rev number. It's going to be interpreted as an octal number and might not build.
#endif
