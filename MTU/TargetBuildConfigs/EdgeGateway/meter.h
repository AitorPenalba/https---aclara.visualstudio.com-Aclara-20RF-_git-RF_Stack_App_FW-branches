...
#define ACLARA_DA                         1  /* Target is Aclara DA */
#define ACLARA_LC                         0  /* Target is Aclara LC */
...
#define SIGNAL_NW_STATUS                  1
#define VSWR_MEASUREMENT                  1  // Supports VSWR measurements of antenna
