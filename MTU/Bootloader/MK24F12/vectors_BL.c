...
extern void          BL_DefaultISR(void);

/*lint -esym(526, __iar_program_start, __BOOT_STACK_ADDRESS) defined at time of link */
/*lint -esym(714, _cfm, blFwVersion_) not referenced by bootloader, just application */
/*lint -esym(528, _cfm, __vector_table) not referenced by bootloader, just application */
/*lint -esym(765, blFwVersion_) attempt to make static causes value to be excluded from binary */

#define FLASH_JTAG_LOCKED  0  /* 0=Flash security disabled, !0= FlashSecurity enabled */
...
#if FLASH_JTAG_LOCKED
   #warning "FLASH/JTAG LOCKED"
      /* FPROT0(MSbits):FPROT3(LSbits) in 32K regions; MSb=0x000F_8000-0x000F_FFFF, ..., LSb=0x0000_0000-0x0000_7FFF */
   #define CONFIG_3        (uint32_t)0x80000000
      /* FSEC (only Flash Security enabled), FOPT (NMI enabled, EzPort enabled, LowPower Boot disabled), RSVD, RSVD */
   #define CONFIG_4        (uint32_t)0xffffffff
#else
      /* FPROT0(MSbits):FPROT3(LSbits) in 32K regions; MSb=0x000F_8000-0x000F_FFFF, ..., LSb=0x0000_0000-0x0000_7FFF */
   #define CONFIG_3        (uint32_t)0xffffffff
      /* FSEC (All Security disabled), FOPT (NMI enabled, EzPort enabled, LowPower Boot disabled), RSVD, RSVD */
   #define CONFIG_4        (uint32_t)0xfffffffe
#endif

#define BOOT_START      __iar_program_start
#define DEFAULT_VECTOR  BL_DefaultISR
...
const uint32_t _cfm[4] = { CONFIG_1, CONFIG_2, CONFIG_3, CONFIG_4};
...
/*lint -e{708} union initialization   */
const intvec_elem __vector_table[] =
{
    (vector_entry)__BOOT_STACK_ADDRESS,   /*lint !e611 !e740 suspicious/unusual cast  */
    BOOT_START,             /* 0x01  0x00000004   -   ivINT_Initial_Program_Counter     */
    DEFAULT_VECTOR,         /* 0x02  0x00000008   -   ivINT_NMI                         */
    0,                      /* 0x03  0x0000000C   -   ivINT_Hard_Fault                  */
    ...
    DEFAULT_VECTOR,         /* 0x0B  0x0000002C   -   ivINT_SVCall                      */
    DEFAULT_VECTOR,         /* 0x0C  0x00000030   -   ivINT_DebugMonitor                */
    0,                      /* 0x0D  0x00000034   -   ivINT_Reserved13                  */
    DEFAULT_VECTOR,         /* 0x0E  0x00000038   -   ivINT_PendableSrvReq              */
    ...
    DEFAULT_VECTOR,         /* 0x22  0x00000088   -   ivINT_FTFx                        */
    ...
    DEFAULT_VECTOR,         /* 0x2D  0x000000B4   -   ivINT_Reserved45                  */
    DEFAULT_VECTOR,         /* 0x2E  0x000000B8   -   ivINT_Reserved46                  */
    DEFAULT_VECTOR,         /* 0x2F  0x000000BC   -   ivINT_Reserved47                  */
    DEFAULT_VECTOR,         /* 0x30  0x000000C0   -   ivINT_Reserved48                  */
    DEFAULT_VECTOR,         /* 0x31  0x000000C4   -   ivINT_Reserved49                  */
    DEFAULT_VECTOR,         /* 0x32  0x000000C8   -   ivINT_Reserved50                  */
    DEFAULT_VECTOR,         /* 0x33  0x000000CC   -   ivINT_Reserved51                  */
    DEFAULT_VECTOR,         /* 0x34  0x000000D0   -   ivINT_Reserved52                  */
    DEFAULT_VECTOR,         /* 0x35  0x000000D4   -   ivINT_Reserved53                  */
    DEFAULT_VECTOR,         /* 0x36  0x000000D8   -   ivINT_Reserved54                  */
    DEFAULT_VECTOR,         /* 0x37  0x000000DC   -   ivINT_Reserved55                  */
    ...
    DEFAULT_VECTOR,         /* 0x4D  0x00000134   -   ivINT_Reserved77                  */
    ...
    DEFAULT_VECTOR,         /* 0x5B  0x0000016C   -   ivINT_Reserved91                  */
    DEFAULT_VECTOR,         /* 0x5C  0x00000170   -   ivINT_Reserved92                  */
    DEFAULT_VECTOR,         /* 0x5D  0x00000174   -   ivINT_Reserved93                  */
    DEFAULT_VECTOR,         /* 0x5E  0x00000178   -   ivINT_Reserved94                  */
